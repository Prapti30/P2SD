    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {thresholdAlerts.map((alert) => (
          <Card key={alert.id} className={`p-6 border-l-4 ${alert.severity === "critical" ? "border-l-danger" : "border-l-warning"}`}>
            <div className="flex items-start justify-between mb-4">
              ...
              <Badge variant={alert.severity === "critical" ? "destructive" : "secondary"} className={alert.severity === "warning" ? "bg-warning text-warning-foreground" : ""}>
